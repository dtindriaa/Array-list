...
public class Data_Perpustakaan {
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("1", "Dita Indriawati"));
        dataMahasiswa.add(new Mahasiswa("2", "Hendery Wong"));
        dataMahasiswa.add(new Mahasiswa("3", "Jung Jaehyun"));
        
         ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Bahasa Korea"));
    dataBuku.add(new Buku("2", "Bahasa Indonesia"));
    dataBuku.add(new Buku("3", "Matematika"));
